...
// Načtení ticketů pro adminy včetně jména autora a filtrování podle stavu "open"
$stmt = $pdo->prepare("
    SELECT t.*, u.username 
    FROM tickets t 
    LEFT JOIN dc_users u ON t.discord_id = u.discord_id 
    WHERE t.type = ? AND t.status = 'open'
    ORDER BY t.created_at DESC
");
$stmt->execute([$type_param]);
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="tickets.php" class="active">
                            ...
                            <?php if ($new_ticket_count > 0): ?>
                                <span class="notification-badge"><?php echo $new_ticket_count; ?></span>
                            <?php endif; ?>
                        </a>
                    </div>
                </li>
...
<body>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-6">Admin Tickety</h1>
