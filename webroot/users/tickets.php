...
if (!$user || !in_array($user['role_id'], [2, 4, 5])) {
...
// Načtení ticketů pro všechny typy (včetně jména autora) a filtrování podle stavu "open"
$stmt = $pdo->prepare("
    SELECT t.*, u.username 
    FROM tickets t 
...
<header>
    <nav class="nav">
        <ul>
            ...
            <li><a href="tickets.php" class="active">Moje Tickety</a></li><br>
            ...
            <?php if (in_array($role_id, [2, 4, 5])): ?>
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="tickets.php" class="active">Tickety</a>
                    </div>
                </li>
            <?php endif; ?>
...
<body>
    <div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-6">Moje Tickety</h1>
        ...
        <?php if (count($tickets) > 0): ?>
            <?php foreach ($tickets as $ticket): ?>
                <div class="mb-4 p-4 border rounded bg-gray-50 shadow-sm hover:shadow transition">
                    ...
                    <p class="text-gray-600"><strong>Vytvořeno:</strong> <?= $ticket['created_at'] ?></p>
                    <p class="text-gray-600">
                        <strong>Kdo řeší ticket:</strong> <?= htmlspecialchars($ticket['who'] ?? 'Nikdo') ?>
                    </p>
                    <a href="../../php/ticket_detail.php?id=<?= $ticket['id'] ?>"
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p class="text-gray-500">Zatím jste nevytvořili žádné tickety.</p>
        <?php endif; ?>
    </div>
</body>
<footer>
